...
if test_cartesian_accuracy_flag:
    ...
    for goal_position in goal_positions:
        ...
        # Compute MSE from the goal position
        mse = root_mean_squared_error(goal_position, final_cartesian_pos)**2
        print(f"Mean Squared Error (MSE) from the goal position: {mse} \n")

...
for depth in [None, 2, 10]:
    ...
    if test_cartesian_accuracy_flag:
        ...
        # for joint_idx in range(7):
        #     # Check the maximum depth of each tree in the trained RandomForestRegressor
        #     tree_depths = [estimator.tree_.max_depth for estimator in models[joint_idx].estimators_]
        #     max_depth_of_forest = max(tree_depths)
        #     print(f'Max depth of the Random Forest model for Joint {joint_idx+1}: {max_depth_of_forest}')

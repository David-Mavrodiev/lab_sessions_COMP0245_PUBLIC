...
# test Bagging
bagging_regressor = BaggingRegressor(estimator=DecisionTreeRegressor(max_depth=13), n_estimators=80, random_state=42) # skilearn update! base_estimator => estimator
